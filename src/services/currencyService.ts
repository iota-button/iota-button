...
export class CurrencyService {
     ...
     */
    public static readonly SYMBOL_MAP: { [id: string]: string } = {
        // TODO Something wrong with this syntax in my Rollup need to investigate. I'm sorry United Arab's for now.
        // AED: "د.إ",
        AFN: "؋",
        ALL: "L",
        AMD: "֏",
